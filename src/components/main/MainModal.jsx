    ...
    <div className="fixed top-0 flex justify-center items-center w-screen h-screen ">
      <div className="w-96 h-[60vh] bg-[#38386d] rounded-xl p-4 relative">
        ...
        <div className="flex flex-col gap-8 mt-4">
          <input className="p-2" type="text" placeholder="пишите название" />
          <input className="p-2" type="number" placeholder="пишите цену" />
          <input className="p-2" type="number" placeholder="пишите размер" />
        </div>
